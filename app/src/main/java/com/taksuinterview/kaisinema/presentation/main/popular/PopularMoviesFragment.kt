...
class PopularMoviesFragment : BaseFragment(), Popular.View {
    @Inject
    lateinit var presenter: Popular.Presenter<Popular.View>
    ...
    override fun showPopularMovies(movies: List<MovieSum>) {
        if (movies.isEmpty()) {
